...
import players.mcts.SushiGoPlayer;
...
public class RoundRobinTournament extends AbstractTournament {
    ...
    public static void main(String[] args) {
        ...
        int matchups = getArg(args, "matchups", 20);
        ...
        if (!playerDirectory.equals("")) {
            ...
            SushiGoPlayer player = new SushiGoPlayer() ;
            MCTSParams params = new MCTSParams();
            MCTSPlayer player1 = new MCTSPlayer (params) ;
            player1.setStateHeuristic (new SushiGoHeuristic()) ;

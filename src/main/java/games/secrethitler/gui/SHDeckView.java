...
public class SHDeckView extends DeckView<SHPlayerCards> {

    String dataPath;
    Image backOfCard;

    public SHDeckView(int player, Deck<SHPlayerCards> d, boolean visible, String dataPath, Rectangle rect) {
    ...
    @Override
    public void drawComponent(Graphics2D g, Rectangle rect, SHPlayerCards card, boolean front) {
    ...
    private Image getCardImage(SHPlayerCards card)
    {

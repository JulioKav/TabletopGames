 ...
 */
public class SHPlayerCards extends Card {
    ...
    protected SHPlayerCards(CardType cardType, int ID){
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof SHPlayerCards)) return false;
        if (!super.equals(o)) return false;
        SHPlayerCards shCard = (SHPlayerCards) o;
